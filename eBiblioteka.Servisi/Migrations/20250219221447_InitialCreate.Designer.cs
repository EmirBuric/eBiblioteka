...
namespace eBiblioteka.Servisi.Migrations
{
    ...
    [Migration("20250219221447_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eBiblioteka.Servisi.Models.Autor", b =>
                {
            ...
            modelBuilder.Entity("eBiblioteka.Servisi.Models.Citaonica", b =>
                {
            ...
            modelBuilder.Entity("eBiblioteka.Servisi.Models.Clanarina", b =>
                {
            ...
            modelBuilder.Entity("eBiblioteka.Servisi.Models.Knjiga", b =>
                {
            ...
            modelBuilder.Entity("eBiblioteka.Servisi.Models.KnjigaAutor", b =>
                {
            ...
            modelBuilder.Entity("eBiblioteka.Servisi.Models.Korisnik", b =>
                {
                    b.Property<int>("KorisnikId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eBiblioteka.Servisi.Models.KorisnikIzabranaKnjiga", b =>
                {
            ...
            modelBuilder.Entity("eBiblioteka.Servisi.Models.KorisnikUloga", b =>
                {
            ...
            modelBuilder.Entity("eBiblioteka.Servisi.Models.Recenzija", b =>
                {
            ...
            modelBuilder.Entity("eBiblioteka.Servisi.Models.Rezervacija", b =>
                {
            ...
            modelBuilder.Entity("eBiblioteka.Servisi.Models.Termin", b =>
                {
            ...
            modelBuilder.Entity("eBiblioteka.Servisi.Models.TipClanarine", b =>
                {
                    b.Property<int>("TipClanarineId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eBiblioteka.Servisi.Models.Uloga", b =>
                {
                    b.Property<int>("UlogaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eBiblioteka.Servisi.Models.Zanr", b =>
                {
                    b.Property<int>("ZanrId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eBiblioteka.Servisi.Models.Clanarina", b =>
                {
                    b.HasOne("eBiblioteka.Servisi.Models.Korisnik", "Korisnik")
                        .WithMany("Clanarinas")
                        .HasForeignKey("KorisnikId")
                        .HasConstraintName("FK__Clanarina__Koris__66603565");

                    b.HasOne("eBiblioteka.Servisi.Models.TipClanarine", "TipClanarine")
                        .WithMany("Clanarinas")
            ...
            modelBuilder.Entity("eBiblioteka.Servisi.Models.Knjiga", b =>
                {
                    b.HasOne("eBiblioteka.Servisi.Models.Zanr", "Zanr")
                        .WithMany("Knjigas")
            ...
            modelBuilder.Entity("eBiblioteka.Servisi.Models.KnjigaAutor", b =>
                {
                    b.HasOne("eBiblioteka.Servisi.Models.Autor", "Autor")
                        .WithMany("KnjigaAutors")
                        .HasForeignKey("AutorId")
                        .HasConstraintName("FK__KnjigaAut__Autor__4222D4EF");

                    b.HasOne("eBiblioteka.Servisi.Models.Knjiga", "Knjiga")
                        .WithMany("KnjigaAutors")
            ...
            modelBuilder.Entity("eBiblioteka.Servisi.Models.KorisnikUloga", b =>
                {
                    ...
                    b.HasOne("eBiblioteka.Servisi.Models.Uloga", "Uloga")
                        .WithMany("KorisnikUlogas")
            ...
            modelBuilder.Entity("eBiblioteka.Servisi.Models.Termin", b =>
                {
                    b.HasOne("eBiblioteka.Servisi.Models.Citaonica", "Citaonica")
                        .WithMany("Termins")
