...
namespace eBiblioteka.Servisi.Migrations
{
    ...
    [Migration("20250609101009_removeValueFromOdobrenaRezervacija")]
    partial class removeValueFromOdobrenaRezervacija
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("eBiblioteka.Servisi.Database.Clanarina", b =>
                {
                    ...
                    b.Property<bool>("StatusClanarine")
                        .HasMaxLength(50)
                        .HasColumnType("bit");
