...
class _IzvjestajScreenState extends State<IzvjestajScreen> {
    ...
    try {
      ...
      final anchor = html.AnchorElement(href: url)
        ..setAttribute('download',
            'izvjestaj_knjiga_${DateTime.now().millisecondsSinceEpoch}.pdf')
        ..click();
  ...
  Future<void> _generateClanarinasPdf() async {
    ...
    try {
      ...
      final anchor = html.AnchorElement(href: url)
        ..setAttribute('download',
            'izvjestaj_clanarine_${DateTime.now().millisecondsSinceEpoch}.pdf')
        ..click();
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 16),
                                  const Text(
                                    'Molimo odaberite knjigu i period za prikaz izvjestaja',
                                    style: TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold,
                                    ),
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 16),
                                  const Text(
                                    'Molimo odaberite mjesec i godinu za prikaz izvjestaja',
                                    style: TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold,
                                    ),
